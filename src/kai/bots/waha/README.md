...
```bash
bash scripts/setup_media.sh
```

This downloads pre-built `ffmpeg` and `whisper.cpp` binaries plus the whisper
base model into `vendor/` and `models/`. No compilation or cmake required.
